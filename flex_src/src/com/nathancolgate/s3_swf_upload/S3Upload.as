package com.nathancolgate.s3_swf_upload {
  ...
  public class S3Upload extends S3UploadRequest {
    ...
    private function progressHandler(progress_event:ProgressEvent):void {
      ...
      ExternalInterface.call('s3_swf.onUploadProgress',_upload_options,progress_event,toJavascript(this.fileReference));
    ...
    private function completeHandler(event:Event):void{
      ...
      ExternalInterface.call('s3_swf.onUploadComplete',_upload_options,event,toJavascript(this.fileReference));
